...
import { getTracks } from '../../utils/methods'

export default class LiveAarti extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      playSeconds: 0,
      duration: 0,
      artiTrackFile: getTracks(StaticData.playlist)
    }
  ...
  render() {
    ...
    console.log('thiss',this.state.artiTrackFile)

    return (
      <SafeAreaView style={styles.playerContainer}>
        <Image source={{ uri: this.state?.artiTrackFile?.cover }} style={styles.mainImage} />
